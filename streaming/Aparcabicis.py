...
def run(argv=None, save_main_session=True):
  ...
  parser.add_argument('--input_topic',
                      ...
                      default='projects/hackaton-5f/topics/aparcabicis',
  ...
  parser.add_argument('--input_subscription',
                      ...
                      default='projects/hackaton-5f/subscriptions/streaming2',
  ...
  Locaparcabicis = p | beam.io.ReadFromPubSub(subscription=known_args.input_subscription)

  # Print messages received
 
  
  
  Locaparcabicis  = ( Locaparcabicis  | beam.ParDo(LocationConcat()))
  
  Locaparcabicis  | 'Print Quote' >> beam.Map(print)
  
  # Store messages on elastic
  Locaparcabicis  | 'Location Aparcabicis' >> beam.ParDo(IndexDocument())
